  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/manage-availability/:serviceId/:serviceName/:selectedDate" element={<ManageAvailability />} />
        <Route path="/calendar-admin/:serviceId/:serviceName" element={<AdminCalender />} />
